...
--
-- Host: localhost    Database: leaguedb
-- ------------------------------------------------------
...
<<<<<<< HEAD
=======
INSERT INTO `stats` VALUES (1,'manticore',3,2,16,10,20),(13,'user1',0,0,0,0,0);
>>>>>>> origin/master
...
<<<<<<< HEAD
=======
INSERT INTO `user` VALUES (1,'manticore','thelevimatusproject@','test'),(13,'user1',NULL,'test');
>>>>>>> origin/master
...
--
-- Dumping routines for database 'leaguedb'
--
...
/*!50003 SET sql_mode              = 'NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `create_new_user`(IN username varchar(30),
...
=======
-- Dump completed on 2015-11-30 17:45:50
>>>>>>> origin/master
